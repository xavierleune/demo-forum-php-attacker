...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get install -y apache2 php7.2-cli php7.2-curl php7.2-json php7.2-mysql oracle-java10-set-default php7.2-dom libapache2-mod-php7.2
    ...
    ln -s /vagrant/provisionning/demo-forum-php-attacker.conf /etc/apache2/sites-enabled/0000-demo-forum-php-attacker.conf
    ln -s /vagrant/provisionning/default-server-name.conf /etc/apache2/conf-enabled/default-server-name.conf
    ...
    cp /var/www/demo/provisionning/elasticsearch.yml /etc/elasticsearch/elasticsearch.yml
